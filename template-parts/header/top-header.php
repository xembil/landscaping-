  ...
  <div id="topbar">
    <div class="container">
            ...
            <?php if( get_theme_mod( 'vw_gardening_landscaping_search_hide_show',true) != '') { ?>
              <div class="col-lg-1 col-md-1">
                <div class="search-box">
                  <a href="#" onclick="vw_gardening_landscaping_search_open()"><span><i class="fas fa-search"></i></span></a>
                </div>
              </div>
            <?php }?>
          </div>
      ...
      <div class="serach_outer">
        ...
        <a href="#main" onclick="vw_gardening_landscaping_search_close()" class="closepop"><i class="fa fa-window-close"></i></a>
      </div>
    </div>
  </div>
<?php }?>